...
public class SendFoodAdapter extends RecyclerView.Adapter<SendFoodAdapter.ViewHolder> {
    ...
    // Конструктор
    public SendFoodAdapter(Activity context, List<FoodData> dataList) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        final FoodData data = dataList.get(position);
        // Инициализация БД
        ...
        holder.btDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Initialize main data
                FoodData d = dataList.get(holder.getAdapterPosition());
                // Удаление текста из БД
                database.foodDao().delete(d);
