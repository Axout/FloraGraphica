...
public class SalesFoodActivity extends AppCompatActivity {
    ...
    public void addScanDataToDB(String scanResult) {
        ...
        // Удаление из table_food отправленной на Варшавку упаковки
        database.foodDao().delete(foodData);
    ...
    private void showMessage(String text) {
        ...
        toast = Toast.makeText(SalesFoodActivity.this, text, Toast.LENGTH_SHORT);
        toast.show();
    }
    ...
    private void showMessageCenter(String text) {
        ...
        toast = Toast.makeText(SalesFoodActivity.this, text, Toast.LENGTH_LONG);
